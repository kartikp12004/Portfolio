...
const Hero = React.forwardRef<HTMLElement, unknown>((_, ref) => {
  return (
    ...
    >
      ...
      >
        Hey, I&apos;m Kartik Pandey, a Cloud Architect and Frontend Developer passionate about
      ...
      >
        <motion.a
          ...
          whileHover="hover"
          href="https://www.linkedin.com/in/karthikpandey12/" // Replace '#' with your LinkedIn profile URL
          target="_blank"
        ...
        <motion.a
          ...
          href="https://drive.google.com/file/d/1LIdDkScRFegF-Ca2erhoeL3KhKv24WPL/view?usp=sharing" // Replace '#' with the Google Drive link to your resume
          target="_blank"
          rel="noopener noreferrer"
